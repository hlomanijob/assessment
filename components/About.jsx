    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          <p className='uppercase text-xl tracking-widest text-[#670086]'>
            About
          </p>
          ...
          <p className='py-2 text-gray-600'>
            I have spent the last 6 years in the Corperate World working as a
            Sales Consultant. I have always had a knack for
          ...
          <p className='py-2 text-gray-600'>
            ...
            now spending my time building projects with HTML, CSSS, PHP, WordPress, JS, MySQL, and
